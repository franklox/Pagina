<?php 
  ...
  if(isset($_SESSION['carrito'])) { //Si ya existe una petición
        if(isset($_GET['id']))
        {
                ...
                ?>
                  <tr>
                    ...
                    <td class="product-name">
                      <h6 class="text-black"><?php echo $arregloCarrito[$i]['Nombre']; ?></h6>
                    </td>
                    <td>$<?php echo $arregloCarrito[$i]['Precio'];?></td>
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
                        <div class="input-group-prepend">
                          <button style="width:20px;" class="btn btn-dark js-btn-minus btnIncrementar" type="button">&minus;</button>
                        </div>
                        ...
                        <div class="input-group-append">
                          <button style="width:20px;" class="btn btn-dark js-btn-plus btnIncrementar" type="button">&plus;</button>
                        </div>
                      </div>
          ...
          <div class="col-md-12 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-dark btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Continuar al pago</button>
                  </div>
                </div>
              </div>
            </div>
